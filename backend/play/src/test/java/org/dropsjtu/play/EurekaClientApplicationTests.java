...
@SpringBootTest(classes = PlayApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
public class EurekaClientApplicationTests {
    ...
    public void shouldRegisterClientInEurekaServer() throws InterruptedException {
        ...
        ResponseEntity<String> response = this.testRestTemplate.getForEntity("http://localhost:" + this.port + "/service-instances/wordladder-play", String.class);

        then(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        then(response.getBody()).contains("wordladder-play");
    }
